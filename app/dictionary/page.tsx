...
function DictionaryContent() {
  ...
  const terms = [
    ...
    { category: "거시경제", word: "골디락스", desc: "경제가 너무 뜨겁지도, 너무 차갑지도 않은 딱 적당한 상태를 말합니다. 저물가와 적정한 성장이 공존하여 주식 투자에 가장 유리한 환경으로 꼽힙니다." },
    { category: "거시경제", word: "기축통화", desc: "국제 금융 거래에서 기본이 되는 통화로, 현재는 미국의 달러가 그 역할을 하고 있습니다. 전 세계 어디서나 결제가 가능하고 가치가 안정적인 돈을 뜻합니다." },
    { category: "거시경제", word: "경기선행지수", desc: "실제 경기가 변하기 전, 약 3~10개월 앞서 움직이는 지표입니다. 주가, 건설 수주량 등을 통해 미래의 경제가 좋아질지 나빠질지 미리 예측하는 데 사용됩니다." },
    ...
    { category: "투자전략", word: "적립식 투자 (DCA)", desc: "주가 변동과 상관없이 매월 일정 금액을 꾸준히 매수하는 전략입니다. 주가가 낮을 땐 더 많은 수량을, 높을 땐 적은 수량을 사게 되어 장기적으로 평균 매수 단가를 낮추는 효과가 있습니다." },
    { category: "투자전략", word: "탑다운 & 바텀업", desc: "경제 전체 흐름을 보고 산업과 종목을 고르는 방식(탑다운)과, 개별 기업의 가치와 실적을 먼저 보고 투자하는 방식(바텀업)을 말합니다." },
    { category: "투자전략", word: "헤지 (Hedge)", desc: "투자 자산의 가격 변동 위험을 상쇄하기 위해 반대되는 성격의 자산에 함께 투자하는 것입니다. 예상치 못한 손실로부터 내 자산을 보호하는 '보험' 같은 전략입니다." },
    ...
    { category: "지수/상품", word: "사이드카 (Sidecar)", desc: "선물 시장의 급등락이 현물 시장에 큰 영향을 미치지 않도록 프로그램 매매를 5분간 일시 정지시키는 제도입니다. 시장의 과열을 식히는 일종의 안전장치입니다." },
    { category: "지수/상품", word: "서킷브레이커 (Circuit Breaker)", desc: "주가가 갑자기 폭락할 때 시장 전체의 매매를 아예 일시 중단시키는 제도입니다. 사이드카보다 더 강력한 조치로, 투자자들에게 냉정함을 찾을 시간을 강제로 부여합니다." },
    ...
    { category: "지수/상품", word: "코스피 (KOSPI)", desc: "한국 거래소에 상장된 종합주가지수입니다. 주로 삼성전자, 현대차 같은 덩치가 큰 우량 기업들이 모여 있는 한국 증시의 대표 성적표입니다." },
    { category: "지수/상품", word: "코스닥 (KOSDAQ)", desc: "IT, 바이오, 콘텐츠 등 성장성이 높은 중소·벤처기업 중심의 시장입니다. 미국의 나스닥과 성격이 비슷하며, 변동성이 크지만 높은 수익을 기대할 수 있는 종목이 많습니다." },
    { category: "지수/상품", word: "MSCI 지수", desc: "미국의 모건스탠리 캐피털 인터내셔널사가 발표하는 글로벌 주가지수입니다. 전 세계 투자자들이 포트폴리오를 짤 때 가장 많이 참고하는 기준(벤치마크)으로, 여기에 편입되느냐에 따라 대규모 외국인 자금이 들어오고 나갑니다." }
  ];
